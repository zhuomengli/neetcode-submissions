    ...
    func groupAnagrams(_ strs: [String]) -> [[String]] {
        ...
        for str in strs {
            ...
            // keyToStrings[key] = newList
             ...
             let key = String(str.sorted()) // sorted is elements[], must String() 【note1】
            keyToStrings[key, default: []].append(str) // key points!!! explain  【note2】
            /*
            ///// default syntax provide mutable access into the hashmap directly
            ///// if no default, then it need assign back manually!!!!!!!
